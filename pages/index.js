      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#023020] text-white relative p-4">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center max-w-[1440px] w-full">
          <Image
            ...
            className="mb-8"
          />
          <h1 className="text-4xl text-center font-light max-w-[800px] mb-12 leading-tight font-kaisei">
        ...
        <div className="flex justify-center gap-8 mt-8 relative z-10">
          <Link href="https://medium.com/@stablebond">
            <a className="text-white hover:text-gray-300 transition-colors duration-200 text-base font-kaisei">
              Research
            </a>
          </Link>
